<template>
    <div>
        ...
        <form @submit.prevent="unlock" class="p-8 max-w-[25rem] mx-auto text-center text-white lock-form radius-16">
            <h4 class="text-2xl text-center font-normal mb-6 text-90">{{ user.name }}</h4>
            ...
            <LoadingButton class="w-full flex justify-center radius-16 py-6 mb-3" type="submit"
                :disabled="form.processing" :loading="form.processing">
                <span>
                    {{ __('Unlock') }} <Icon type="arrow-right"></Icon>
                </span>
            </LoadingButton>
